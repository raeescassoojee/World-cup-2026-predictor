...
```bash
# Clone the repo
git clone https://github.com/raeescassoojee/World-cup-2026-predictor.git
...
Built by Raees Cassoojee as part of a BSc Honours in Data Science portfolio project.
